...
export const normalizeTitle = (title) => {
  ...
  return String(title)
    ...
    .replace(/네팔\s*\(\s*히말라야\s*산맥\s*\)/g, '네팔 (히말라야 ○○)')
    .replace(/네팔\s*\(히말라야\s*○○\)/g, '네팔 (히말라야 ○○)')
    .replace(/나이지리아\s*\(\s*고원\s*\)/g, '나이지리아 (○○)')
    .replace(/나이지리아\s*\(○○\)/g, '나이지리아 (○○)')
    .replace(/브라질\s*\(\s*아마존강\s*\)/g, '브라질(아마존○)')
    .replace(/브라질\s*\(아마존○\)/g, '브라질(아마존○)')
    .replace(/베트남[·\s]*타이\s*\(\s*메콩강[·\s]*짜오프라야강\s*\)/g, '베트남·타이 (메콩○·짜오프라야○)')
    .replace(/베트남[·\s]*타이\s*\(메콩○[·\s]*짜오프라야○\)/g, '베트남·타이 (메콩○·짜오프라야○)')
    .replace(/캐나다\s*\(\s*오타와강\s*\)/g, '캐나다 (오타와○)')
    .replace(/캐나다\s*\(오타와○\)/g, '캐나다 (오타와○)')
    ...
    .replace(/몽골\s*\(○○\)/g, '몽골 (○○)')
    .replace(/알제리\s*\(\s*사하라\s*사막\s*\)/g, '알제리(사하라○○)')
    .replace(/알제리\s*\(\s*사하라\s*○○\s*\)/g, '알제리(사하라○○)')
    .replace(/알제리\s*\(사하라○○\)/g, '알제리(사하라○○)')
    .replace(/알제리\s*\(\s*사막\s*\)/g, '알제리(사하라○○)')
    .replace(/알제리\s*\(○○\)/g, '알제리(사하라○○)')
    .replace(/노르웨이\s*\(○○○\s*○○\)/g, '노르웨이(○○○ ○○)')
    .replace(/네덜란드\s*\(바덴해\s*○○\s*○○\)/g, '네덜란드(바덴해 ○○ ○○)')
    .replace(/인도네시아\s*\(\s*발리섬\s*모래\s*해안\s*\)/g, '인도네시아 (발리섬 모래 ○○)')
    .replace(/인도네시아\s*\(발리섬\s*모래\s*○○\)/g, '인도네시아 (발리섬 모래 ○○)')
    .replace(/오스트레일리아\s*\(\s*산호\s*해안\s*\)/g, '오스트레일리아 (○○ ○○)')
    .replace(/오스트레일리아\s*\(\s*암석\s*해안\s*\)/g, '오스트레일리아(○○ ○○)')
