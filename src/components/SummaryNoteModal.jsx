      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1.5rem' }}>
          <div>
            ...
            <p style={{ fontSize: '0.85rem', color: '#b3b3b3', marginTop: '4px' }}>
              ...
              >
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    ...
                    <span style={{ fontWeight: 700, fontSize: '1rem', color: isCompleted ? '#1ed760' : '#ffffff' }}>
                      {loc.name}
                    </span>
                  </div>
                  <span
                ...
                <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                  ...
                  />
                  <div style={{ fontSize: '0.8rem', color: '#b3b3b3', flex: 1, display: 'flex', flexDirection: 'column', gap: '3px' }}>
                ...
                {isCompleted && ans ? (
                  <div style={{ background: '#121212', padding: '10px', borderRadius: '8px', border: '1px solid #282828', fontSize: '0.82rem' }}>
                    <div style={{ color: '#1ed760', fontWeight: 700, marginBottom: '2px' }}>
                      ✏️ 학생 제출 작성 내용:
                    </div>
                    ...
                    <div style={{ color: '#1ed760', fontWeight: 700, marginBottom: '2px', borderTop: '1px solid #282828', paddingTop: '6px' }}>
                      📘 교과서 모범 답안:
                    </div>
                    <div style={{ color: '#b3b3b3', lineHeight: 1.4 }}>
                      {loc.modelAnswer}
                    </div>
                  </div>
                ) : (
                  <div style={{ background: '#121212', padding: '8px 10px', borderRadius: '8px', fontSize: '0.8rem', color: '#71717a' }}>
